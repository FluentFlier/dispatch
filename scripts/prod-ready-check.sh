...
echo "  7. db/evolving-model.sql         # edit_feedback, workspace_watchlists, voice_drift"
echo ""
echo "  bash scripts/apply-all-intelligence.sh   # after: npx @insforge/cli login && link"
echo ""
echo "=== Hosting ==="
