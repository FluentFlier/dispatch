    ...
    <Suspense
      fallback={
        <div className="space-y-6">
          <h1 className="font-display font-[800] text-[21px] text-[#0F172A] tracking-[-0.02em] leading-[1.2]">
            Generate
          </h1>
...
function GeneratePageInner() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="font-display font-[800] text-[21px] text-[#0F172A] tracking-[-0.02em] leading-[1.2]">Generate</h1>
