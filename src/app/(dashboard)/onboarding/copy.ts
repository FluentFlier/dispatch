...
export const COPY = {
  ...
  steps: {
    ...
    connect: {
      ...
      confirmingTitle: 'Confirming your social account...',
      confirmingHint: 'This usually takes just a few seconds. Keep this page open.',
      connectionSuccessTitle: 'Social account connected',
      connectionSuccessNamed: '{name} is ready to use in Content OS.',
      connectionSuccessHint: 'Your account is ready to use in Content OS.',
      connectionPendingTitle: 'Connection received',
      connectionPendingHint:
        'Your provider is still confirming the account. You can continue, or reconnect if it does not appear below shortly.',
      connect: 'Connect',
