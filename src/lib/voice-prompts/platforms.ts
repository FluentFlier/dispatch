...
- Line breaks for scanability; no hashtag spam (0–2 max).
...
- Hashtags at end (3–8) unless brief says otherwise.
- CTA: save, share, or comment prompt — match post type.`,
...
export const CONTENT_TYPE_HINTS: Record<VoiceContentType, string> = {
  ...
  comment: 'Comment: 1–3 sentences max; helpful or witty, never preachy.',
};
