 ...
 * but Unipile does (imagine's pipeline ran on this for months): impressions,
 * reactions, comments, and reposts, spread across an `analytics` object
 * and/or flat `*_counter` fields depending on post age and API version.
 */
