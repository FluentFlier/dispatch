 ...
 *
 * Ported from the battle-tested patterns in the imagine LinkedIn pipeline:
 ...
 * runaway loops, not a billing-grade quota. Mirrors imagine's usage-tracker.
 */
 ...
 * activity doesn't fire at a robotically fixed time. Same trick imagine uses
 * (there via seedrandom).
 */
